...
class list
{
    //دالة كلاس العام لاضافة الاستركت
public:
...
// the function of the struct Node
...
int main()
{
    ...
    else if (A == 3)
    {
        ...
        start = NULL;
        while (1)
        //حلقه لتكرار الشرط أثناء التنفيذ
        {
            ...
            switch (choice)
            {
                //دالة الswitch للتبديل عند الخيارات
            case 1:
                sl.insert_begin();
                cout << endl;
                break;
